...
export let lineChartData: Array<any> = [
  { 'label': 'Settled App', 'yAxisID': 'A', 'data': [17, 60, 43, 46, 37, 36, 34, 10, 0, 0, 0, 0] },
  { 'label': 'Settled Amount', 'yAxisID': 'B', 'data': [62070, 277310, 179821, 254798, 158361, 181113, 105680, 31489, 0, 0, 0, 0] },
  { 'label': 'Total App', 'yAxisID': 'C', 'data': [80, 294, 289, 260, 240, 223, 205, 84, 3, 0, 0, 0] },
  { 'label': 'Conversion Rate', 'yAxisID': 'D', 'data': ['4.71', '4.90', '6.72', '5.65', '6.49', '6.19', '6.03', '8.40', false, false, false, false] }
];
// export let lineChartLabels: Array<any> = ['January', 'February', 'March', 'April', 'May', 'June', 'July'];
export let lineChartLabels: Array<any> = ['May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec', 'Jan', 'Feb', 'Mar', 'Apr'];
